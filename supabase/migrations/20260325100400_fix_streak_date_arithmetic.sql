-- Fix streak consecutive-day check: use integer subtraction (date - 1)
-- instead of (date - interval '1 day') which returns timestamp and risks
...
BEGIN
  ...
  -- Use integer date arithmetic (date - 1) to avoid timestamp coercion issues.
